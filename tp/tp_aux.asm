...
;    sub rax,1
    ...
    je validar_si_oficial_debe_comer_prox_turno ;esto deja en r13 si pueden comer.
...
mostrar_jugador_actual:
    pop r11
    cmp r11, 1
    je mostrar_eliminacion_de_oficial
...
;    sub rax,1
    ...
    mov r11, 1 ;indicar que tengo que imprimir mensaje.
    push r11
